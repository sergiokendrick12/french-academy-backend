...
export default function AdminDashboard() {
  ...
  const pageTitles = {
    ...
    quiz:"Quiz",resources:"Resources",certifications:"Certifications",attendance:"Attendance",
    ...
    <div className="shell">
      ...
      <div className="main">
        ...
        <main className="content">
          ...
          {page==="quiz"?<QuizPage toast={toast}/>:page==="resources"?<ResourcesPage toast={toast}/>:page==="progress"&&<ProgressPage enrollments={enrollments} toast={toast}/>}
