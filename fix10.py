...
before = c[idx:idx+5000]
pos = before.find('{showModal&&(')
absolute_pos = idx + pos
old = c[absolute_pos:absolute_pos+13]
...
c = c[:absolute_pos] + new + c[absolute_pos+13:]
f = open('app/admin/page.js', 'w', encoding='utf-8')
f.write(c)
f.close()
print('Done! Save Changes count:', c.count('Save Changes'))
